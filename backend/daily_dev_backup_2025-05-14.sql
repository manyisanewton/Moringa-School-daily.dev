...
CREATE TABLE public.comments (
    ...
    body text NOT NULL,
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_comment_one_parent CHECK ((((content_id IS NOT NULL) AND (post_id IS NULL)) OR ((content_id IS NULL) AND (post_id IS NOT NULL))))
);
...
COPY public.comments (id, content_id, post_id, user_id, parent_id, body, created_at) FROM stdin;
\.
...
2	manage_content	Can manage content
3	write_content	Can create and edit content
...
1	devnewton21@gmail.com	Newton	$2b$12$1YqNcnF8vWcJTuUC8PbK3OQUTIXhBl9HFeWFl4KuUom8BDTnXCVz6	t	2025-05-14 19:04:56.136484	2025-05-14 19:04:56.136484
\.
...
SELECT pg_catalog.setval('public.role_permissions_id_seq', 5, true);
...
--
-- Name: comments comments_content_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: moringa
--

ALTER TABLE ONLY public.comments
    ADD CONSTRAINT comments_content_id_fkey FOREIGN KEY (content_id) REFERENCES public.contents(id) ON DELETE CASCADE;
