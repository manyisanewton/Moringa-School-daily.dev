...
const AdminProfile = () => {
  ...
  // Load both user info (for email) and profile
  useEffect(() => {
    const load = async () => {
      try {
        // get basic user info
  ...
  const handleSave = async () => {
    try {
      ...
      // if user picked a new file, upload it first (assume /upload endpoint)
      if (photoFile) {
