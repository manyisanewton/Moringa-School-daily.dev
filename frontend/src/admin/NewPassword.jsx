        ...
        try {
            ...
            if (err.response?.data?.error) {
                if (typeof err.response.data.error === "string") {
                    ...
                    errorMessage = errorObj[firstKey]?.[0] || errorMessage;
                }
            } else if (err.message) {
    ...
    return (
        <div className="new-password-container">
            ...
            <div className="new-password-form">
                ...
                <p>
                    Make sure your new password is 8 characters or more. Try including numbers, letters, or punctuation marks for a <span>strong password</span>
                </p>
